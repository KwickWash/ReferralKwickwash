<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sales-report.aspx.cs" Inherits="sales_report" %>
...
<body style="background-color: white !important;">
    <form id="form1" runat="server">
        <ul>
            <li><a class="active" href="sales-report.aspx">Sales Report</a></li>
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-md-12">
                    <h2 class="page-title text-center" style="font-weight: bold; color: darkgreen; text-decoration: underline;">Sales Report</h2>
                </div>
            </div>
                    ...
                    <div class="white-box" style="height: 100px;">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                ...
                                <select id="ddShopName" runat="server" class="form-control">
                                </select>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                ...
                                <select id="ddPaymentStatus" runat="server" class="form-control">
        ...
        <script>
            ...
            function ExportExcel() {
                window.location = "download-sales-report.aspx?id=" + $('#ddShopName').val() + "&fd=" + $('#txtFromDate').val() + "&td=" + $('#txtToDate').val() + "&ps=" + $('#ddPaymentStatus').val();
            }
            ...
            function BindShop() {
                ...
                var url = "https://api.kwickwash.com/api/shoplist/GetShopListRefralWise?rid=" + id + "&status=1";
                //alert(url);
                $.ajax({
                    url: url,
