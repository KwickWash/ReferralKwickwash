<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gst-report.aspx.cs" Inherits="gst_report" %>
<!DOCTYPE html>
...
<body style="background-color: white !important;">
    <form id="form1" runat="server">
        <ul>
            ...
            <li><a class="active" href="gst-report.aspx">GST Report</a></li>
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-md-12">
                    <h2 class="page-title text-center" style="font-weight:bold; color:darkgreen; text-decoration:underline;">GST Report</h2>
                </div>
            </div>
        ...
        <script src="assets/js/jsLoad.js"></script>
                    ...
                    success: function (data) {
                        ...
                        if (typeof (_details) !== 'undefined') {
                            $.each(_details, function (i, object) {
                                ...
                                _htmlTable += ' <td>' + Number(object.gst).toFixed(2) + '</td>';
