    ...
    <form id="form1" runat="server">
        ...
        <script>
            ...
            function ExportExcel() {
                window.location = "download-service-wise-sales-report.aspx?id=" + $('#ddShopName').val() + "&sn=" + $('#ddServiceName').val() + "&fd=" + $('#txtFromDate').val() + "&td=" + $('#txtToDate').val() + "&ps=" + $('#ddPaymentStatus').val();
            }
