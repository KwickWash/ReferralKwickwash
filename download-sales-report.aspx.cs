...
public partial class download_sales_report : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["fd"] != "" && Request.QueryString["fd"] != null && Request.QueryString["id"] != null)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT (o.orderId) AS ORDERID,(o.invoiceNo) AS INVOICENO,(c.companyName)AS SHOPNAME," +
                    "(p.name)As CustomerName,(o.orderDate) AS ORDERDATE,(o.Status) AS PAYMENTSTATUS,(o.paymentMode)AS PAYMENTMODE,(o.ttlAmount) AS AMOUNT," +
                    "(o.DISCOUNTAMOUNT)AS DISCOUNT,(o.ttlPayableAmount)AS PAYABLEAMOUNT FROM tbl.Orders o join tbl.profile p " +
                    ...
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                Response.AddHeader("content-disposition", "attachment;filename=Sales-Report.xlsx");
